...
- [x] 2. Source exploration and data contract (Req 2)
  ...
  - [x] 2.4 Write unit tests for the data models
...
- [x] 3. Core services
  ...
  - [x] 3.2 Write property test for error sanitization
    - **Property 22: Error messages never expose technical details**
    - **Validates: Requirements 10.1, 10.4**

  - [x] 3.3 Implement BedrockService
  ...
  - [x] 3.5 Write property tests for memory round-trips
  ...
  - [x] 3.7 Write property tests for Tavily behavior
...
- [x] 4. Record sources
  ...
  - [x] 4.5 Write property tests for Gmail privacy and scoping
  ...
  - [x] 4.6 Write unit tests for Gmail parsers and source skipping
